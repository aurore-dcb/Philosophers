...
/*   Updated: 2023/10/11 15:22:17 by aducobu          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	create_list_philo(t_data **philo, char **argv, pthread_mutex_t *forks, int time)
{
	int i;
	...
	{
		if (!lst_add_back(philo, lst_new(i, argv, forks, time)))
			return (0);
		i++;
	}
	return (1);
